...
!--------------------------------------------------------------------
         ...
         prod(28) = 0._r8
         loss(29) = ( + rxt(11) + rxt(12) + rxt(13) + het_rates(39))* y(39)
         prod(29) = 0._r8
         loss(30) = ( + het_rates(28))* y(28)
         prod(30) = 0._r8
         loss(31) = ( + het_rates(29))* y(29)
         prod(31) = 0._r8
         loss(32) = ( + het_rates(33))* y(33)
         prod(32) = 0._r8
         loss(33) = ( + het_rates(34))* y(34)
         prod(33) = 0._r8
         loss(34) = ( + het_rates(30))* y(30)
         prod(34) = 0._r8
         loss(35) = ( + het_rates(31))* y(31)
         prod(35) = 0._r8
         loss(36) = ( + het_rates(32))* y(32)
         prod(36) = 0._r8
         loss(37) = ( + het_rates(35))* y(35)
         prod(37) = 0._r8
         loss(38) = ( + het_rates(36))* y(36)
         prod(38) = 0._r8
         loss(39) = ( + het_rates(37))* y(37)
         prod(39) = 0._r8
